        ...
        <div class="container mt-3">
            <nav aria-label="breadcrumb" >
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Hand Of Class</li>
                </ol>
            </nav>
        </div>
        <div class="container">
            ...
            <div class="modal modal-img">
                ...
                <div id="zoom-slide" class="carousel slide" data-ride="carousel" data-interval="false">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="modal-content modal-img-content" id="img01" src="img/img_Slider_section_6.jpg" width="100%" >
                        </div>
                        <div class="carousel-item">
                            <img class="modal-content modal-img-content" id="img01" src="img/img_Slider_section_6.jpg"  width="100%">
                        </div>
